...
export function sha256Hex(buffer: ArrayBuffer) {
  ...
  view.setUint32(withPaddingLength - 8, highBits, false);
  view.setUint32(withPaddingLength - 4, lowBits, false);
  ...
  return `${toHexWord(h0)}${toHexWord(h1)}${toHexWord(h2)}${toHexWord(h3)}${toHexWord(h4)}${toHexWord(h5)}${toHexWord(h6)}${toHexWord(h7)}`;
}
